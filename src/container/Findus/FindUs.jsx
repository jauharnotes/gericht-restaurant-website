  ...
  <div className='findus__container'>
    <div className='findus__wrapper'>
      <div className='findus__left'>
        <h1 className='findus_contact'>Contact</h1>
        ...
        <h2 className='findus__find'>Find Us</h2>
        <p className='findus__desc'>Lane Ends Bungalow, Whatcroft Hall Lane, Rudheath, CW9 7SG</p>
        <h1 className='findus__open'>Opening Hours</h1>
        <p className='findus__date'>Mon - Fri: 10:00 am - 02:00 am</p>
        <p className='findus__date'>Sat - Sun: 10:00 am - 03:00 am</p>
        <button type="button" className="custom__button">Visit Us</button>
      </div>

      <div className='right'>
        <img className='findus_image' src={images.findus} alt="find us foto" />
      </div>
    </div>
  </div>
);
