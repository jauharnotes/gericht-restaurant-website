...
const Chef = () => (
  <div className="app__header app__wrapper section__padding" id="home">
    ...
    <div className="app__wrapper_info">
      ...
      <h1 className="chef__header-h1">What We believe in</h1>
      <div className='c__quote'>
        <svg width="60" height="54" viewBox="0 0 47 41" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="p__opensans chef__opensans">Lorem ipsum dolor sit amet, consectetur adipiscing elit auctor sit.nulla lobortis </p>
      </div>
      <p className="p__opensans chef__opensans" style={{ margin: '0 0 2rem 0' }}>auctor sit iaculis in arcu. Vulputate nulla lobortis mauris eget sit. Nulla scelerisque scelerisque congue ac consequat, aliquam molestie lectus eu. Congue iaculis integer curabitur semper sit nunc.</p>
